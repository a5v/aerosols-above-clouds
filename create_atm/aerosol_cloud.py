...
if __name__ == '__main__':
    ...
    for i in range(N_dTau_aerosol): # iterate over range of aerosol optical depth # N_dTau_aerosol
        ...
        for j in range(4): # iterate over aerosol data used for visible # N_aerosol
            ...
            w0_atm[0] = w0_data_aerosol[j]
            w0_atm[1] = w0_data_cloud[cloud_data_used] # cloud data used
            
    
            uphas_atm = np.zeros((N_layer, maxmom))
            uphas_atm[0] = uphas_data_aerosol[j]
            uphas_atm[1] = uphas_data_cloud[cloud_data_used] # cloud data used
        ...
        for j in range(4,8): # iterate over aerosol data used for IR # N_aerosol
            ...
            w0_atm = np.zeros((N_layer, 1))
            w0_atm[0] = w0_data_aerosol[j]
            w0_atm[1] = w0_data_cloud[cloud_data_used + 6] # cloud data used
            
            uphas_atm = np.zeros((N_layer, maxmom))
            uphas_atm[0] = uphas_data_aerosol[j]
            uphas_atm[1] = uphas_data_cloud[cloud_data_used + 6] # cloud data used
...
name = './atmospheres/ac_'+str(cloud_data_used)+'_'+str(dTau_cloud)+'.csv'
